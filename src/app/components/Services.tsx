...
const Services = () => {
  return (
    <section className="service-section relative py-28">
      <div className="container mx-auto">
        ...
        <div className="hero-content text-white text-center relative z-10 justify-center py-0">
        <h2 className="text-4xl font-extrabold mb-12 text-center text-white">Our Services</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
          ...
          <div className="p-8 rounded-md shadow-lg">
            <h3 className="text-2xl font-semibold mb-4">Maintenance and Support</h3>
            <p className="text-lg mb-6">
