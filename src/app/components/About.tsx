...
const About = () => {
  return (
    <section className="lg:bg-gradient-to-r from-white bg-slate-900 to-gray-900 text-slate-100 lg:py-24 relative overflow-hidden">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="lg:w-1/2 lg:pl-8 z-10 px-4">
          <h2 className="lg:text-3xl font-extrabold mb-4">ModWebSolution</h2>
